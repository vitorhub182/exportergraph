module github.com/vitorhub182/emptyexporter
...
replace github.com/vitorhub182/emptyexporter v0.0.1 => /workspaces/Sistema_Monitor_Microservicos/telemetria/tentativa3/emptyexporter
